...
// server/public/index.html:919-957). После verdict 'has_dirty' работник
// остаётся на экране — у карточки появляется «Начать стирку».
        ...
        {order.map((v, i) => {
          ...
          return (
            <div key={v}>
              ...
              {blocked && (
                <>
                  <div className={styles.washMeta}>По учёту чистого на складе нет</div>
