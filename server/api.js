...
const API_ROLES = {
  ...
  confirmStorageCheck: OWNER_WORKER, addManualClean: OWNER_WORKER, editManualClean: OWNER_WORKER, markIssued: OWNER, updateIssueDate: OWNER,
...
const sessionFirst = {
  ...
  getDeliveryPlan, addToDelivery, cancelWash, deleteWash, confirmStorageCheck, addManualClean, editManualClean, markIssued, updateIssueDate,
  getWeekPlan,
  getStorage, getDayReport, getSummaryReport, getFinanceSummary,
...
const api = {
  ...
  driverReturnClean: deliveries.driverReturnClean,
