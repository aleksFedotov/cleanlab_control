...
const API_SNAPSHOT = [
  ...
  'driverHandover', 'driverReturnClean', 'driverTakeAllClean', 'editExtraWork', 'editManualClean', 'editWashData', 'getClientInvoice', 'getDayList',
...
test('R1-char: снапшот — состав публичного api не изменился (86 методов)', () => {
